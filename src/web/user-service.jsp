<%@ page import="java.util.*,
                 ...
                 org.dynamicsimulations.openfire.plugin.JerseyUserServicePlugin"
    errorPage="error.jsp"
%>
...
<%  // Get parameters
    ...
    JerseyUserServicePlugin plugin = (JerseyUserServicePlugin) XMPPServer.getInstance().getPluginManager().getPlugin(JerseyUserServicePlugin.PLUGIN_NAME);
